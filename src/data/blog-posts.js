...
export const blogPosts = [
  {
    ...
    featured: true,
    keywords: 'facebook ads not generating leads, facebook ads clicks but no leads, facebook ads troubleshooting, lead generation facebook ads',
    bodyContent: `
      <p>If your Facebook ads are getting impressions and clicks but your inbox is empty, you are not alone. This is the single most common complaint I hear from construction companies, ecommerce brands, and home service businesses running Meta Ads. The good news: in 80% of cases, the ad is not the problem. The bad news: that means the fix is somewhere else, and most account managers never look there.</p>
      ...
      <ul>
        <li><strong>Headline matches the ad promise.</strong> If your ad says "Get a roofing quote in 24 hours" and your landing page headline says "Quality Roofing Services Since 2010," you have created dissonance. Match the promise exactly.</li>
        <li><strong>Hero image shows the outcome.</strong> Not a stock photo of a contractor. An actual roof, an actual repair, an actual estimate document.</li>
        <li><strong>The form is visible without scrolling.</strong> On mobile, especially. Bury it below the fold and you lose 40 percent of conversions.</li>
        <li><strong>Trust signals above the form.</strong> License number, years in business, Google review count and rating, recent project photo.</li>
      </ul>
      ...
      <ul>
        <li>First name (last name can come later)</li>
      ...
      <ul>
        <li>Leads contacted within 5 minutes of submission convert at roughly 30 percent.</li>
...

  {
    ...
    bodyContent: `
      ...
      <ul>
        <li><strong>DIY and informational terms.</strong> "How to," "cost of," "average price of," "diy," "vs." These are people researching, not buying.</li>
        <li><strong>Geographic mismatches.</strong> If you serve Victoria BC, clicks from Toronto or Calgary are wasted budget. Check the locations.</li>
        <li><strong>Job seeker terms.</strong> "Jobs," "careers," "hiring," "employment." These will drain your budget fast.</li>
        <li><strong>Competitor terms you can\'t convert.</strong> If your competitor\'s brand name is in your keyword list and your landing page does not directly address why you are better, those clicks rarely convert.</li>
      </ul>
      ...
      <ul>
        ...
        <li><strong>Recent reviews.</strong> Three to five Google reviews with the reviewer name visible.</li>
      </ul>
...

  {
    ...
    bodyContent: `
      ...
      <p>For contractors, the buying decision is high-trust and high-stakes. A new roof costs $15,000 to $30,000. A commercial renovation can be six figures. No one makes that decision without checking reviews.</p>
      <p>The data is consistent across every contractor I have worked with:</p>
      <ul>
        <li>Contractors with 50+ Google reviews convert inbound leads at 2.5X the rate of contractors with under 10 reviews.</li>
        <li>Contractors with a 4.7+ star rating get 30 percent more inbound calls than contractors at 4.2 or below.</li>
        <li>Every 10-review increment above 30 reviews typically increases inbound lead volume by 8 to 12 percent.</li>
      </ul>
      ...
      <ul>
        <li><strong>Ask within 48 hours of project completion.</strong> While the customer is still in the "wow this looks great" phase. Two-week delay cuts response rate by 70 percent.</li>
        <li><strong>Ask in person, then follow up by text.</strong> The in-person ask gets a verbal yes. The text reminder converts the yes into a written review.</li>
        <li><strong>Send a direct link to your review page.</strong> Not "leave us a review on Google." A direct link. People will not search for your business name and click through three pages to find the review form.</li>
        <li><strong>Send one reminder, three days later.</strong> Not five. Two reminders max, then stop. Annoying customers costs you future referrals.</li>
      </ul>
      ...
      <ul>
        ...
        <li><strong>Hour 0:</strong> SMS to customer with direct Google review link.</li>
        <li><strong>Hour 24:</strong> If no review, follow-up SMS with a softer ask.</li>
        <li><strong>Day 5:</strong> If review left, send a thank-you text. If not, send a final email reminder, then stop.</li>
        <li><strong>Day 7:</strong> If a negative review comes in (3 stars or below), trigger an internal alert so you can call the customer before the review goes public.</li>
      </ul>
      <p>This is the same system we build for every contractor client. It runs without you thinking about it and generates 5 to 15 new reviews per month for a typical contractor.</p>

      <h2 id="negative-reviews">4. How to Handle Negative Google Reviews</h2>
      <p>Negative reviews happen. Even great contractors get them. The response is more important than the review itself. Here is the playbook:</p>
      <ul>
        <li><strong>Respond within 24 hours.</strong> Every time. A response says "we care" to the next 50 people who read the review.</li>
        <li><strong>Apologize first, even if you are right.</strong> "I am sorry your experience did not meet your expectations" is not an admission of fault.</li>
        <li><strong>Move the conversation offline.</strong> "Please call me directly at [number] so I can understand what went wrong and make it right."</li>
        <li><strong>Never argue publicly.</strong> Even if the customer is wrong. You look petty and the next 50 readers see it.</li>
        <li><strong>If the review is fake or policy-violating, dispute it.</strong> Google removes reviews that violate their policy (conflicts of interest, spam, off-topic). It takes 5 minutes to flag and Google decides within 7 days.</li>
      </ul>
      <p>The goal of a negative review response is not to win back that customer. It is to demonstrate to the next 50 readers that you are a professional who takes feedback seriously.</p>

      <h2 id="leverage">5. How to Leverage Google Reviews in Your Marketing</h2>
      <p>Reviews do not just sit on Google. They should be feeding every other channel. Here is how to use them:</p>
      <ul>
        <li><strong>Website:</strong> Pull your 5 best reviews into a testimonials section on your home page. Use real names and project types ("Sarah M., New Roof Installation, July 2026").</li>
        <li><strong>Google Ads:</strong> Google Ads pulls your reviews into "seller ratings" that show as stars under your ad. You need 100+ reviews with 4.5+ average to qualify, but when you do, click-through rate jumps 15 to 20 percent.</li>
        <li><strong>Landing pages:</strong> Three to five reviews with the reviewer name visible on every landing page. Especially important for service business landing pages.</li>
        <li><strong>Social media:</strong> Screenshot your best reviews and post them as content. One per week minimum.</li>
      </ul>

      <h2 id="the-cadence">6. The Cadence That Works for Contractors</h2>
      <p>If you do one project per week, you should be generating 2 to 4 new Google reviews per month. If you do five projects per week, you should be at 10 to 20 per month. The math:</p>
      <ul>
        <li>40 to 60 percent of happy customers leave a review when asked properly (with automation + direct link).</li>
        <li>80 percent of customers are happy if your work is good.</li>
        <li>So 32 to 48 percent of completed projects should generate reviews.</li>
      </ul>
      <p>If your numbers are lower than this, the system is broken, not the customers. Fix the ask, fix the timing, fix the automation. Reviews will come.</p>
...

  {
    ...
    readingTime: '12 min read',
    featured: false,
    keywords: 'construction marketing mistakes, contractor marketing mistakes, construction marketing strategy, contractor marketing tips',
    bodyContent: `
      <p>After eight years auditing construction company marketing, I see the same five mistakes over and over. They cost contractors jobs every month, and most of them are fixable with less than $5,000 and 30 days of focus. This guide walks through each one in the order you should fix them.</p>
      ...
      <p>Traffic objective optimises for clicks. Facebook will find people who click a lot but rarely fill out forms or buy. Leads objective optimises for form fills. Conversions objective optimises for whatever you define as a conversion (form submission, phone call, calendar booking).</p>
      ...
      <ul>
        ...
        <li>Instant SMS auto-reply: "Hi [Name], this is Hazeem from PrimeNest. I got your message about your [project type]. I will call you within 5 minutes."</li>
        <li>Lead routed to sales rep via Slack + SMS within 30 seconds</li>
        <li>Rep calls within 5 minutes</li>
      </ul>
      <p>This system costs $200 a month in GoHighLevel and recovers 22 percent of leads most contractors lose. Most contractors I audit before they hire us have 30 to 50 percent of leads that never get called. That is 30 to 50 percent of their marketing budget wasted.</p>

      <h2 id="mistake-5">Mistake 5: Not Tracking Offline Conversions Back to the Ad Platform</h2>
      <p>Contractors do not close deals online. They close deals on the phone, in the kitchen, on the job site. Google Ads and Facebook see "form submit" as the conversion. But the real conversion happens 7 to 14 days later when the customer signs the contract.</p>
      <p>If you are not feeding that data back to Google and Facebook, their algorithms are optimising on form submits, not contracts. The fix is offline conversion tracking:</p>
      <ul>
        <li>Lead submits form → records as "Lead" conversion in ad platform</li>
        <li>Lead becomes qualified → records as "Qualified Lead" conversion</li>
        <li>Lead signs contract → records as "Closed Deal" conversion (with contract value)</li>
      </ul>
      <p>This requires a CRM that can talk to Google and Facebook APIs (GoHighLevel does this natively). Once set up, the ad platforms start optimising on contract value, not form fills. Cost per closed deal typically drops by 30 to 50 percent within 60 days.</p>

      <h2 id="fix-order">The Order to Fix These Mistakes</h2>
      <p>If you have all five of these mistakes in your construction marketing, fixing them in this order will give you the biggest lift for the least effort:</p>
      <ul>
        <li><strong>Week 1:</strong> Fix mistake 4 (follow-up speed). Cheapest, fastest, biggest immediate lift.</li>
        <li><strong>Week 2:</strong> Fix mistake 1 (landing pages). One-time investment, pays off for years.</li>
        <li><strong>Week 3:</strong> Fix mistake 3 (audience structure). Improve ad efficiency.</li>
        <li><strong>Week 4:</strong> Fix mistake 2 (campaign objective). Switch from Traffic to Conversions.</li>
        <li><strong>Week 5+:</strong> Fix mistake 5 (offline conversion tracking). This is the long-term multiplier.</li>
      </ul>
      <p>Fixing all five typically lifts construction marketing ROI by 80 to 150 percent within 90 days.</p>
...

  {
    ...
    bodyContent: `
      ...
      <ul>
        ...
        <li><strong>Touchpoint 2: The Trigger.</strong> After every project, the customer gets a sequence of emails/SMS over the next 90 days that reminds them you exist, asks for a review, asks for a referral, and shares relevant project updates.</li>
        <li><strong>Touchpoint 3: The Reward.</strong> When a referral comes in and converts, the original customer gets a thank-you gift. $200 to $500 depending on the project size. Publicly acknowledged.</li>
      </ul>
      ...
      <ul>
        ...
        <li><strong>Day 3:</strong> Email with project photos + "5 tips to maintain your new [roof/kitchen/etc]" content.</li>
        <li><strong>Day 14:</strong> Email asking for a referral. "Know anyone planning a similar project? We offer $250 referral rewards."</li>
        <li><strong>Day 30:</strong> SMS asking how the project is holding up + soft referral ask.</li>
        <li><strong>Day 60:</strong> Email with seasonal content ("5 things to check on your roof before winter").</li>
        <li><strong>Day 90:</strong> Final referral ask + check-in.</li>
      </ul>
      <p>Each touchpoint has a tracking link so you know exactly which email produced which referral. The system runs without thinking and generates 2 to 5 referrals per completed project over a 90-day window.</p>
      ...
      <ul>
        ...
        <li>Mention the reward. Removes the awkwardness of "are they going to pay me?"</li>
        <li>Say "no pressure." People do not refer when they feel pressured.</li>
        <li>Do it in person or by phone, not email. Email is too easy to ignore.</li>
      </ul>
      ...
      <ul>
        ...
        <li><strong>Large jobs ($50K to $200K):</strong> $500 to $1,500.</li>
        <li><strong>Commercial jobs ($200K+):</strong> $1,500 to $5,000.</li>
      </ul>
      <p>Pay on contract signing, not on project completion. The referring customer wants to feel appreciated in the moment, not 6 months later.</p>
      <p>Also: send the reward publicly when possible. A handwritten card + a small gift + a shout-out on your social media. The next 50 customers see it and remember the next time they have someone to refer.</p>

      <h2 id="measurement">6. Measuring Referral Performance</h2>
      <p>What gets measured gets managed. The metrics that matter for a referral system:</p>
      <ul>
        <li><strong>Referral rate:</strong> Percentage of completed projects that generate a referral within 90 days. Target: 25 to 40 percent.</li>
        <li><strong>Referral conversion rate:</strong> Percentage of referral leads that close. Target: 40 to 60 percent.</li>
        <li><strong>Cost per referral lead:</strong> Total system cost / number of referral leads. Target: $50 to $150.</li>
        <li><strong>Revenue per referral lead:</strong> Average contract value × close rate. Target: $3,000 to $15,000.</li>
      </ul>
      <p>If you are tracking these four numbers, you can see immediately when the system is working and when it is not. Most contractors track none of these. They wonder why referrals are "hit or miss." It is because there is no system.</p>
...

  {
    ...
    featured: false,
    keywords: 'roofing sales funnel, contractor sales funnel, roofing lead generation, roofing marketing funnel',
    bodyContent: `
      ...
      <ul>
        ...
        <li><strong>Stage 2: Landing page.</strong> Service-specific landing page with 3-field form</li>
        <li><strong>Stage 3: Instant follow-up.</strong> SMS auto-reply within 30 seconds, phone call within 5 minutes</li>
        <li><strong>Stage 4: Nurture.</strong> Email + SMS sequence for leads that did not book immediately</li>
        <li><strong>Stage 5: Close.</strong> Calendar booking for on-site estimate + automated proposal follow-up</li>
      </ul>
      ...
      <ul>
        ...
        <li>Each campaign has 3 ad groups bucketed by intent</li>
        <li>5 to 15 keywords per ad group, tightly themed</li>
        <li>Two ads per ad group (one direct, one benefit-led)</li>
        <li>Budget: $4,000/month, target CPA $150</li>
      </ul>
      <p><strong>Facebook Ads structure:</strong></p>
      <ul>
        <li>Two campaigns: Prospecting (broad audience) + Retargeting (website visitors + page engagers)</li>
        <li>Prospecting uses Conversions objective, optimising for form fills</li>
        <li>Retargeting uses Lead Generation objective with native Facebook form</li>
        <li>Budget: $2,000/month, target CPA $80</li>
      </ul>
      ...
      <ul>
        ...
        <li><strong>Second 30:</strong> Lead receives SMS: "Hi [Name], this is the PrimeNest team. Got your message about your roofing project. I will call you within 5 minutes to learn more."</li>
        <li><strong>Second 60:</strong> Lead routed to owner's phone via Slack + SMS notification.</li>
        <li><strong>Minute 5:</strong> Owner calls the lead.</li>
        <li><strong>Minute 10:</strong> If owner has not called, second SMS to lead apologising for delay and offering to text instead.</li>
      </ul>
      ...
      <ul>
        ...
        <li><strong>Day 3:</strong> Email with 5 Google reviews from recent roofing clients</li>
        <li><strong>Day 7:</strong> Email with "5 things to check on your roof before winter" content</li>
        <li><strong>Day 14:</strong> SMS asking if they want a second opinion on a competitor quote</li>
        <li><strong>Day 30:</strong> Email with case study of a similar project in their area</li>
        <li><strong>Day 60:</strong> SMS check-in ("Still planning your roofing project?")</li>
        <li><strong>Day 90:</strong> Final email offering a $200 discount if they book in the next 30 days</li>
      </ul>
      ...
      <ul>
        ...
        <li>Lead books a 60-minute on-site estimate within 24 to 72 hours</li>
        <li>Calendly sends automated reminders (24 hours before, 1 hour before)</li>
        <li>On-site visit happens, owner writes proposal within 48 hours</li>
        <li>Proposal sent via GoHighLevel with email + SMS notification</li>
        <li>If proposal not signed in 5 days, automated follow-up sequence triggers</li>
      </ul>
      ...
      <ul>
        ...
        <li>Cost per lead: $0 (referrals) → $90 to $130 (paid ads)</li>
        <li>Close rate: 25% → 35% (40% improvement)</li>
        <li>Revenue: $180K → $580K per month (3.2X lift)</li>
        <li>Marketing ROI: 6:1 → 11:1</li>
      </ul>
...

  {
    ...
    featured: false,
    keywords: 'losing clients to competitors, positioning strategy, how to compete with worse competitors, differentiation strategy',
    bodyContent: `
      <p>The most frustrating thing in business is losing a deal to a competitor you know does worse work. You have been doing this for 10 years. Their portfolio is one project. Their reviews are fake. They quoted 30 percent less than you and they got the job.</p>
      ...
      <ul>
        ...
        <li>How quickly you respond (5 minutes vs 5 days)</li>
        <li>How clearly you communicate (specifics vs vague promises)</li>
        <li>What other people say about you (reviews, testimonials, case studies)</li>
        <li>How you handle the discovery call (questions you ask vs pitch you give)</li>
      </ul>
      ...
      <ul>
        ...
        <li><strong>Materials specified by brand and model.</strong> Generic "architectural shingles" loses to "CertainTeed Landmark PRO in Colonial Slate." Specificity signals expertise.</li>
        <li><strong>Timeline with milestones.</strong> "Day 1 tear-off, Day 2 deck inspection, Day 3-4 installation, Day 5 final inspection and cleanup."</li>
        <li><strong>Warranty terms in writing.</strong> 25-year manufacturer warranty + 5-year workmanship warranty. Your competitor who offered "yeah we warranty our work" loses to that.</li>
        <li><strong>Photos of similar past projects.</strong> 3 recent projects with the same scope, in the same area. With addresses if you can.</li>
      </ul>
      ...
      <ul>
        <li>If they have 80 reviews and you have 12, you are 68 reviews behind.</li>
        <li>If you generate 5 new reviews per month, you catch them in 14 months.</li>
        <li>If you generate 10 per month, you catch them in 7 months.</li>
      </ul>
      ...
      <ul>
        ...
        <li>Contractor B responds in 2 hours</li>
        <li>Contractor C responds in 2 days</li>
      </ul>
      ...
      <p>When you ask first, the customer feels heard. When you pitch first, they feel sold. The first wins 70 percent more deals than the second.</p>

      <h2 id="positioning-statement">7. Write Your Positioning Statement</h2>
      <p>Most contractors cannot answer the question "why should I hire you instead of your competitor" in one sentence. They say "we do quality work" or "we have great service." These are not differentiators. Every contractor says these.</p>
      <p>A real positioning statement has three elements:</p>
      <ul>
        <li><strong>Who you serve:</strong> "Homeowners in Greater Victoria with homes 15+ years old"</li>
        <li><strong>What you do:</strong> "Roof replacements and major repairs with a 5-year workmanship warranty"</li>
      ...
      <ul>
        <li>Response speed (cheapest, fastest)</li>
        <li>Review volume (system, takes 6-12 months)</li>
        <li>Proposal specificity (one-time investment)</li>
        <li>Case studies (3-5 stories on your site)</li>
        <li>Discovery call reframe (training, 1 week)</li>
        <li>Positioning statement (one afternoon)</li>
        <li>Social proof on every page (one-time setup)</li>
      </ul>
...

  {
    ...
    readingTime: '10 min read',
    featured: false,
    keywords: 'instagram lead generation construction, instagram for contractors, construction instagram marketing, contractor instagram strategy',
    bodyContent: `
      ...
      <ul>
        ...
        <li>Posts that are project photos with captions like "Another great project! 🏗"</li>
        <li>No CTA in any post</li>
        <li>No way for a follower to become a lead without leaving Instagram and Googling you</li>
      </ul>
      ...
      <ul>
        ...
        <li><strong>Pillar 2: Educational content (40% of posts).</strong> "3 signs your roof needs replacing before winter." "How to spot a bad contractor quote." "What a 25-year shingle warranty actually covers." Educational content builds authority and gets saved (which boosts the algorithm).</li>
        <li><strong>Pillar 3: Behind-the-scenes (20% of posts).</strong> Your crew on site. Your process. A time-lapse of a project. These posts humanize the brand and build trust.</li>
      </ul>
      ...
      <ul>
        ...
        <li><strong>Step 6:</strong> Qualified lead books on-site estimate</li>
        <li><strong>Step 7:</strong> Proposal sent within 48 hours</li>
        <li><strong>Step 8:</strong> Automated follow-up sequence if not signed within 5 days</li>
      </ul>
      <p>Each step has a measurable conversion rate. The product of those rates is the funnel-wide conversion rate from Instagram follower to closed contract. For our construction clients, that product averages 0.5 to 1.2 percent of bio link clicks.</p>
      <p>That sounds low, but with 100 bio link clicks per month (very achievable for an active account), that is 1 to 2 closed contracts per month from Instagram. At an average contract value of $20,000, that is $20K to $40K per month from a free channel.</p>

      <h2 id="posting-cadence">6. The Posting Cadence That Works</h2>
      <p>Instagram rewards consistency. Posting 3 times a week consistently for 6 months beats posting 7 times a week for 2 weeks and then disappearing. The cadence we use for construction clients:</p>
      <ul>
        <li><strong>Monday:</strong> Educational post (carousel or Reel)</li>
        <li><strong>Wednesday:</strong> Project showcase (3-photo carousel or Reel)</li>
        <li><strong>Friday:</strong> Behind-the-scenes (Reel or single photo)</li>
      </ul>
      ...
      <h2 id="measurement">8. Measuring Instagram Lead Generation</h2>
      <p>Instagram Insights shows you reach, impressions, likes, comments. None of these are leads. The metrics that matter:</p>
      <ul>
        <li><strong>Bio link clicks per month.</strong> Target: 50 to 200 per month for an active account.</li>
        <li><strong>Landing page conversion rate from Instagram traffic.</strong> Target: 8 to 15 percent.</li>
        <li><strong>Cost per lead (if running Instagram ads).</strong> Target: $40 to $80.</li>
        <li><strong>Lead-to-close rate from Instagram leads.</strong> Target: 20 to 35 percent.</li>
      </ul>
...

  {
    ...
    featured: false,
    keywords: 'klaviyo email marketing, klaviyo flows, ecommerce email flows, abandon cart klaviyo, klaviyo automation',
    bodyContent: `
      ...
      <ul>
        <li><strong>They send campaigns, not flows.</strong> Campaigns are one-off emails. Flows are automated sequences. Flows generate 70 percent of email revenue for mature stores. Campaigns generate 30 percent.</li>
        <li><strong>They have 2 flows, not 5.</strong> The default Klaviyo setup comes with Welcome and Abandoned Cart. That is 30 percent of potential email revenue. The other 70 percent comes from 3 more flows.</li>
        <li><strong>They segment by gut, not behaviour.</strong> Sending the same email to everyone gets the same open rate from everyone. Segmenting by browse behaviour, purchase history, and engagement level typically lifts revenue per email by 40 to 60 percent.</li>
      </ul>
      ...
      <ul>
        ...
        <li><strong>Email 2 (Day 2):</strong> Brand story + why we exist + social proof</li>
        <li><strong>Email 3 (Day 4):</strong> Best sellers + social proof + soft CTA to shop</li>
        <li><strong>Email 4 (Day 7):</strong> Discount code reminder + urgency (expires in 24 hours)</li>
      </ul>
      <p>Key elements:</p>
      <ul>
        <li>Discount code in the first email, not the second. People who subscribe for a discount and do not get it immediately unsubscribe.</li>
        <li>Brand story in email 2, not email 1. Email 1 should be transactional (here is your code). Email 2 builds the relationship.</li>
        <li>Best sellers in email 3 with social proof (reviews, photos). This is the converting email.</li>
      ...
      <ul>
        ...
        <li><strong>Cart abandoners (last 7 days):</strong> Abandoned cart flow.</li>
      </ul>
      <p>Each segment gets a different message. Sending the same campaign to all 5 segments lifts open rate by 8 to 12 percent. Sending tailored campaigns lifts open rate by 25 to 35 percent.</p>

      <h2 id="measurement">8. Measuring Klaviyo Performance</h2>
      <p>The metrics that matter for Klaviyo:</p>
      <ul>
        <li><strong>Email revenue as % of total revenue:</strong> Target 25 to 35 percent for mature stores, 10 to 15 percent for stores < 1 year old</li>
        <li><strong>Revenue per email subscriber:</strong> Target $1 to $3 per subscriber per month</li>
        <li><strong>Flow revenue as % of email revenue:</strong> Target 60 to 70 percent (the rest is campaigns)</li>
        <li><strong>Open rate:</strong> Target 35 to 50 percent (below 30 percent means list quality is bad or subject lines are weak)</li>
        <li><strong>Click rate:</strong> Target 5 to 10 percent (below 3 percent means content is irrelevant)</li>
      </ul>
      ...
      <ul>
        ...
        <li><strong>Week 1, Day 3-5:</strong> Build Browse Abandonment flow. Set up send-time optimisation.</li>
        <li><strong>Week 2, Day 1-3:</strong> Build Post-Purchase flow. 5 emails over 60 days.</li>
        <li><strong>Week 2, Day 4-5:</strong> Build Win-Back flow. 3 emails over 10 days.</li>
        <li><strong>Week 2, Day 6-7:</strong> Set up segmentation. Build VIP, recent purchaser, lapsed, and newsletter-only segments.</li>
      </ul>
      <p>Once all 5 flows are live and segmentation is in place, email revenue typically jumps from 5 to 10 percent of total revenue to 25 to 35 percent within 60 to 90 days.</p>
...

  {
    ...
    bodyContent: `
      ...
      <ul>
        ...
        <li><strong>Campaign 2: Lead Generation (Retargeting).</strong> People who visited your site or engaged with your social in the last 30 days. Smaller audience, higher intent.</li>
        <li><strong>Campaign 3: Conversions (Lead Form + CRM).</strong> Sends leads directly into your CRM with instant SMS auto-reply. Higher cost per lead but better-qualified leads.</li>
      </ul>
      ...
      <ul>
        <li><strong>Prospecting:</strong> Homeowners in your service area, age 30+. That is it. Let Facebook find the converters from a broad base.</li>
        <li><strong>Retargeting:</strong> Website visitors in the last 30 days. Plus people who engaged with your Instagram or Facebook in the last 30 days.</li>
        <li><strong>Lookalike:</strong> 1% lookalike of your past customers. Facebook finds people similar to those who already hired you.</li>
      </ul>
      ...
      <ul>
        ...
        <li><strong>Recent reviews.</strong> 3 to 5 Google reviews with the reviewer name visible.</li>
      </ul>
      ...
      <ul>
        <li>Lead submits form on landing page</li>
        <li>Webhook fires to GoHighLevel within 1 second</li>
        <li>Lead receives SMS auto-reply within 30 seconds: "Hi [Name], this is [Company]. Got your message about your [service type]. I will call you within 5 minutes."</li>
        <li>Lead routed to dispatcher / technician via Slack + SMS within 60 seconds</li>
        <li>Dispatcher calls lead within 5 minutes</li>
      </ul>
      ...
      <ul>
        ...
        <li><strong>Retargeting (30%):</strong> $900 to $3,000/month. Website visitors + social engagers.</li>
        <li><strong>Creative production (20%):</strong> $600 to $2,000/month. New creatives, video editing, founder content.</li>
      </ul>
      <p>Most home service businesses spend 90 percent on ads and 0 percent on creative production. They burn through the same 2 creatives for 6 months until ad fatigue kills the account. Allocate 20 percent to creative and your account will outperform competitors who spend 2X your budget.</p>

      <h2 id="measurement">7. Measuring Facebook Ads for Home Service</h2>
      <p>The metrics that matter for home service Facebook ads:</p>
      <ul>
        <li><strong>Cost per lead:</strong> Target $40 to $80 (varies by service type and market)</li>
        <li><strong>Lead-to-customer conversion rate:</strong> Target 25 to 40 percent (lower than other industries because home service leads are often price-shopping)</li>
        <li><strong>Cost per customer:</strong> Target $100 to $300 (cost per lead / lead-to-customer rate)</li>
        <li><strong>Revenue per customer:</strong> Target $300 to $2,000+ depending on service</li>
        <li><strong>ROAS (return on ad spend):</strong> Target 3:1 to 8:1 (varies by service and lifetime value)</li>
      </ul>
      <p>If your cost per lead is above $80, your landing page or creative is the issue. If your lead-to-customer rate is below 25 percent, your follow-up is the issue. Diagnose before you scale.</p>

      <h2 id="common-mistakes">8. Common Mistakes Home Service Businesses Make</h2>
      <p>The mistakes I see most often in home service Facebook ad accounts:</p>
      <ul>
        <li><strong>Traffic objective instead of Lead/Conversions.</strong> Optimises for clicks, not leads. Cheaper clicks, more expensive leads.</li>
        <li><strong>Sending traffic to homepage.</strong> Generic page, low conversion rate. Build service-specific landing pages.</li>
        <li><strong>Long forms.</strong> 7+ fields kills conversion. 3 fields is optimal for home service.</li>
        <li><strong>No follow-up automation.</strong> Leads called "when there is time." Conversion rate drops to 5 percent.</li>
        <li><strong>Stale creative.</strong> Same 2 creatives for 6 months. Ad fatigue kills performance.</li>
        <li><strong>Not retargeting.</strong> Website visitors are warm. Spend 30 percent of budget retargeting them.</li>
      </ul>
...

  {
    ...
    bodyContent: `
      ...
      <ul>
        ...
        <li><strong>3-field contact form.</strong> Name, phone, project type. Anything longer kills conversion rate.</li>
        <li><strong>Mobile-first responsive design.</strong> 60 to 70 percent of contractor website traffic is mobile. If your site does not work on mobile, you are losing 60 percent of leads.</li>
      ...
      <ul>
        ...
        <li><strong>Video background on hero.</strong> Looks beautiful, slows page load, hurts SEO, annoys mobile users. Use a static hero image instead.</li>
        <li><strong>Blog with no content.</strong> A blog that has not been updated in 2 years signals abandonment. Either commit to publishing monthly or remove the blog section.</li>
        <li><strong>Animation-heavy design.</strong> Parallax scrolling, fade-in elements, complex transitions. They delay the user from finding what they came for: your phone number and contact form.</li>
      ...
      <ul>
        ...
        <li><strong>What you do.</strong> 3 to 5 services listed.</li>
        <li><strong>Where you work.</strong> Service area visible.</li>
        <li><strong>Why trust you.</strong> License + reviews + years in business.</li>
        <li><strong>How to contact you.</strong> Phone number + contact form + click-to-call button.</li>
      </ul>
      ...
      <ul>
        ...
        <li><strong>Hero image.</strong> Real photo of the service being performed.</li>
        <li><strong>Trust signals above the fold.</strong> License, reviews, insurance.</li>
        <li><strong>3-field form.</strong> Name, phone, project type.</li>
        <li><strong>Service details.</strong> What is included, what is not, timeline, warranty.</li>
        <li><strong>Project photos.</strong> 6 recent projects of this service type.</li>
        <li><strong>FAQ.</strong> 5 to 7 common questions with concise answers.</li>
        <li><strong>Reviews.</strong> 3 to 5 reviews specific to this service type.</li>
        <li><strong>CTA repeated.</strong> Form or click-to-call at the bottom.</li>
      </ul>
      ...
      <ul>
        ...
        <li><strong>Sticky CTA.</strong> "Get a Quote" button pinned to the bottom of the screen.</li>
        <li><strong>Form fields above the fold.</strong> Do not make mobile users scroll to find the form.</li>
        <li><strong>Thumb-friendly navigation.</strong> Hamburger menu, large tap targets, no hover-only elements.</li>
      ...
      <ul>
        ...
        <li><strong>Schema markup.</strong> LocalBusiness schema on your home page. Tells Google your business name, address, phone, hours, services.</li>
        <li><strong>Page titles and meta descriptions.</strong> "Roofing Contractor Victoria BC | [Company Name]" not just "[Company Name]".</li>
        <li><strong>Service-specific H1.</strong> Each landing page has one H1 that includes the service + location.</li>
        <li><strong>NAP consistency.</strong> Name, address, phone identical across your site, Google Business Profile, and 30+ local directories.</li>
      </ul>
      ...
      <ul>
        ...
        <li><strong>Shopify.</strong> Best for contractor ecommerce (selling materials, parts). Not ideal for service businesses.</li>
        <li><strong>GoHighLevel.</strong> Best for contractors who want website + CRM + automation in one platform. Easier to maintain, less flexible than WordPress.</li>
        <li><strong>Wix / Squarespace.</strong> Avoid. Limited SEO, limited flexibility, hard to migrate away from.</li>
      </ul>
      <p>We recommend WordPress for most contractor sites. GoHighLevel if you want everything in one platform.</p>

      <h2 id="cost">8. What a Construction Website Should Cost</h2>
      <p>Contractor websites range from $2,000 to $50,000+. What you should expect at each level:</p>
      <ul>
        <li><strong>$2,000 to $5,000:</strong> Template-based, 5 to 7 pages, basic SEO. Good for new contractors.</li>
        <li><strong>$8,000 to $15,000:</strong> Custom design, 10 to 15 pages including service-specific landing pages, mobile-first, SEO foundations. Good for established contractors.</li>
        <li><strong>$15,000 to $30,000:</strong> Custom design, 20+ pages, advanced SEO, conversion optimisation, ongoing maintenance. Good for contractors doing $1M+ in revenue.</li>
        <li><strong>$30,000+:</strong> Enterprise-grade, custom integrations, multi-location, ongoing content production. Overkill for most contractors.</li>
      </ul>
...

  {
    ...
    readingTime: '11 min read',
    featured: false,
    keywords: 'local seo for contractors, local seo 2026, google business profile, local seo strategy, contractor local seo',
    bodyContent: `
      <p>Local SEO is the cheapest, most compounding marketing channel for contractors and service businesses. Unlike paid ads, which stop the moment you stop paying, local SEO keeps producing leads month after month with minimal maintenance. The catch: it takes 3 to 6 months to start working, and most contractors give up before that.</p>
      ...
      <ul>
        ...
        <li>Month 3: 2 to 5 leads per month from local SEO</li>
        <li>Month 6: 8 to 15 leads per month from local SEO</li>
        <li>Month 12: 15 to 30 leads per month from local SEO</li>
        <li>Month 24+: 30 to 60 leads per month from local SEO (with content + reviews)</li>
      </ul>
      ...
      <ul>
        ...
        <li>GBP listings with 50+ reviews get 200% more calls than those with under 10</li>
        <li>GBP listings with weekly posts get 2 to 3 times more website clicks than those without</li>
      </ul>
      <p>The optimisation checklist:</p>
      <ul>
        <li><strong>Verify your business.</strong> Postcard verification takes 1 to 2 weeks.</li>
        <li><strong>Fill out every field.</strong> Hours, services, service area, attributes (women-owned, family-owned, etc.).</li>
        <li><strong>Add 10+ photos.</strong> Team photos, project photos, logo, cover photo, before/after.</li>
        <li><strong>Publish weekly posts.</strong> Project showcase, special offer, educational content. Once a week minimum.</li>
        <li><strong>Get reviews on a cadence.</strong> 1 to 5 new reviews per week minimum. Use the system in the Google Reviews Guide.</li>
        <li><strong>Respond to every review.</strong> Within 24 hours. Personalised, not templated.</li>
      ...
      <ul>
        ...
        <li><strong>Page titles and meta descriptions.</strong> "Roofing Contractor Victoria BC | [Company Name]" not just "[Company Name]". Each page should have a unique title.</li>
        <li><strong>Service-specific H1 on each page.</strong> Each landing page has one H1 that includes the service + location.</li>
        <li><strong>NAP consistency.</strong> Name, address, phone identical across your site, Google Business Profile, and local directories. Even minor variations (St vs Street) hurt rankings.</li>
        <li><strong>Page speed.</strong> 90+ Lighthouse score. Mobile users bounce at 3 seconds.</li>
      </ul>
      ...
      <ul>
        ...
        <li><strong>Second tier:</strong> Yelp, YellowPages, BBB, Foursquare, TripAdvisor (for relevant businesses)</li>
        <li><strong>Industry-specific:</strong> Houzz (for contractors), Angi, Houzz, Porch, HomeAdvisor (for home services)</li>
        <li><strong>Local directories:</strong> Chamber of Commerce, local business associations, neighborhood Facebook groups</li>
      </ul>
      ...
      <ul>
        ...
        <li><strong>Cornerstone content.</strong> 1,500 to 3,000 word guide on your main service. "The Complete Guide to Roof Replacement in Victoria BC."</li>
        <li><strong>Educational articles.</strong> 800 to 1,500 word articles on common customer questions. "5 Signs Your Roof Needs Replacing," "How Much Does a New Roof Cost in Victoria BC."</li>
        <li><strong>Case studies.</strong> 500 to 1,000 word write-ups of recent projects. Include photos, timeline, customer quote.</li>
        <li><strong>Local content.</strong> Articles about local events, local building codes, local permit processes. Shows Google you are local.</li>
      </ul>
      ...
      <ul>
        ...
        <li><strong>Local media.</strong> Press release for a notable project, interview with a local news outlet, guest post on a local blog.</li>
        <li><strong>Supplier websites.</strong> Many suppliers list certified installers on their site. Get listed.</li>
      ...
      <ul>
        ...
        <li>Increase click-through rate from search results (star ratings visible)</li>
        <li>Convert leads at higher rate (social proof)</li>
      </ul>
      <p>The cadence that works:</p>
      <ul>
      ...
      <p>The metrics that matter for local SEO:</p>
      <ul>
        <li><strong>Google Business Profile insights:</strong> Calls, website clicks, direction requests per month</li>
        <li><strong>Organic traffic from local searches:</strong> Track in Google Search Console, filter by query containing your city name</li>
        <li><strong>Organic leads per month:</strong> Track in CRM by source "organic search"</li>
        <li><strong>Rankings for target keywords:</strong> "[service] + [city]" searches. Use a rank tracker like Local Falcon or Whitespark</li>
        <li><strong>Citation count:</strong> Number of local directory listings. Use BrightLocal or similar.</li>
      </ul>
      ...
      <ul>
        ...
        <li><strong>Month 12+:</strong> Established local presence. 25 to 50 leads per month. Local SEO is your most cost-effective channel.</li>
      </ul>
      <p>The first 6 months are the hardest. Most contractors give up at month 4 because they are not seeing results. The contractors who push through to month 6+ get the compounding rewards.</p>
